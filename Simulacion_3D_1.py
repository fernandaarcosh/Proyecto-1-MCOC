# -*- coding: utf-8 -*-
"""
Created on Fri Aug 23 19:30:43 2019
...
def q(t):
    ...
    t_r = 15
    t_c = 32
    return Ht * 308800.0*(thau/t)**betha*(betha/t) * alpha_u * np.exp(-(thau/t)**betha) * np.exp (E/R*(1/(273+t_r)- 1/(273+t_c))) 

#Parametros del problema (hormigon con cemento puzolanico)
dt = 1.0        # s
K = 9.87        # m^2 / s   
c = 0.983       # J / kg C
rho = 2425.0    # kg / m^3
...
for k in range(10080):
    ...
    u_k[-1,:,:] = u_k[-2,:,:]    #du/dy(x,0,z,t)=0  Cara lateral 2
...
#Algoritmo de diferencias finitas 3-D para difusion
                ...
                #Forward euler..
                u_km1[i,j,Z] = u_k[i,j,Z] + alpha*nabla_u_k + q(t)
